...
const productManagementApi = {
  ...
  form: async () => ({ country: "Thailand", topic: "Create New Account (ลูกค้าใหม่)", schema: { legacyScreenPattern: "{CC}_สร้างAccountลูกค้า", legacyFormPattern: "Form* (DataSource: USR_PowerApp)", lookupRequirements: [], implementationStatus: "PARTIAL" as const }, fields: [] }),
